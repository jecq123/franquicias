...
public interface SucursalRepositorioReactive extends ReactiveCrudRepository<SucursalEntidad, Long> {
    @Modifying
    @Query("UPDATE sucursal SET nombre = :nuevoNombre WHERE id = :id")
